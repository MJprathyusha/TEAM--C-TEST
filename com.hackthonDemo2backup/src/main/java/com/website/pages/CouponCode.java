...
public class CouponCode {
	...
	public CouponCode(WebDriver ldriver) {
		this.driver = ldriver;
	}
	...
	/*
	 * @FindBy(xpath = "//a[@title='Ceiling Lights']") WebElement ceiling
	 */
	...
	WebElement Shop;
	@FindBy(linkText = "Industrial Modern")
	WebElement ind;

	@FindBy(xpath = "//*[@id=\"refinement-YL_BestSellerScore\"]/div[2]/ul/li[1]/a/span[1]/input")
	WebElement ready;
	@FindBy(xpath = "//img[@alt='Bluff City 14-Inch Pendant Light']")
	WebElement img;
	...
	WebElement promo;
	@FindBy(xpath="//*[@id=\"dwfrm_cart\"]/fieldset/table/tfoot/tr/td/div[2]/div[1]/div[1]/button/span") WebElement apply;

	public void WebElements(String uid,String pword,String code) {
			close.click();
			acc.click();
			sign.click();
			uname.sendKeys(uid);
			...
			JavascriptExecutor javaScriptExecutor1 = (JavascriptExecutor)driver;
		      ...
		      close1.click();
			    ...
			    promo.sendKeys(code);
System.out.println("code enter successfully;");
apply.click();
