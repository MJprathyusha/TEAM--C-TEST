...
public class Zip_Code {
	...
	public Zip_Code(WebDriver ldriver) {
		this.driver = ldriver;
	}
	...
	WebElement cart;
	@FindBy(xpath="//*[@id=\"dwfrm_cart\"]/fieldset/table/tfoot/tr/td/div[2]/div[2]/div[1]/div[2]/table/tbody/tr[4]/td/div/input[1]")
	WebElement zip;
	@FindBy(xpath="//input[@class='taxCalcBtn']")
	WebElement go;
	
	public void WebElements(String uid, String pword, String URL,String Zip) {
		close.click();
		acc.click();
		sign.click();
		uname.sendKeys(uid);
		...
		zip.sendKeys(Zip);
		System.out.println("zip code sent");
		go.click();
		System.out.println("zip code applied");
	}
