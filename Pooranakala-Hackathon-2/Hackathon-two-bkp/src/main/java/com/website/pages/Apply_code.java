...
public class Apply_code {
	WebDriver driver;

	public Apply_code(WebDriver ldriver) {
		this.driver = ldriver;
	}
	...
	WebElement code;
	@FindBy(xpath="//*[@id=\"dwfrm_cart\"]/fieldset/table/tfoot/tr/td/div[2]/div[1]/div[1]/button/span")
	WebElement apply;
	
	public void WebElements(String uid, String pword, String URL,String coupon) {
		close.click();
		acc.click();
		sign.click();
		uname.sendKeys(uid);
		...
		code.sendKeys(coupon);
		System.out.println("coupon sent");
		apply.click();
