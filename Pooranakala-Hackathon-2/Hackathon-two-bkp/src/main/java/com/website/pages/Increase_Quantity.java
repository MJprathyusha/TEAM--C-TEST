...
public class Increase_Quantity {
	...
	public Increase_Quantity(WebDriver ldriver) {
		this.driver = ldriver;
	}
...
// WebElement close1;
	...
	WebElement cart;
	@FindBy(xpath="//*[@id=\"dwfrm_cart\"]/fieldset/table/tbody/tr[1]/td[2]/table/tbody/tr[1]/td[3]/div/span[2]")
	WebElement increase;
	...
	public void WebElements(String uid, String pword, String URL) {
		...
		increase.click();
		System.out.println("increased the quantity");
	}
}
